 ...
 */
{
   ...
   #endif
   #if ATL_KBCONST == 0
      const size_t incAm = (lda<<3), incBn = ldb*6;
   #else
   ...
   for (j=0; j < N; j += 6)
   {
      for (i=0; i < M; i += 8)
      {
         register ATL_VTYPE rA0, rA1, rA2, rA3, rA4, rA5, rA6, rA7, rB0, rC00,
                            ...
                            rC14, rC24, rC34, rC44, rC54, rC64, rC74, rB5, rC05,
                            rC15, rC25, rC35, rC45, rC55, rC65, rC75;
         ...
         ATL_vmul(rC55, rA5, rB5);
            ATL_vld(rA5, pA4+lda); pA4 += ATL_VLEN;
         ATL_vmul(rC65, rA6, rB5);
            ATL_vld(rA6, pA6);
         ATL_vmul(rC75, rA7, rB5);
            ATL_vld(rA7, pA6+lda); pA6 += ATL_VLEN;
         pfA += 48; pfB += 48;
/*
 ...
 */
         for (k=(ATL_VLEN<<1); k < ATL_MM_KB; k += ATL_VLEN)
         {
            ...
            ATL_vmac(rC55, rA5, rB5);
               ATL_vld(rA5, pA4+lda); pA4 += ATL_VLEN;
            ATL_vmac(rC65, rA6, rB5);
               ATL_vld(rA6, pA6);
            ATL_vmac(rC75, rA7, rB5);
               ATL_vld(rA7, pA6+lda); pA6 += ATL_VLEN;
         }  /* end K-loop */
/*
 ...
 */
            ...
            ATL_vvrsum2(rC65, rC75);
               ...
               ATL_vbeta(pC0+6, rC65);
                  ...
                  ATL_vvrsum4(rC05, rC25, rC15, rC35); // rC00={r3, r1, r2, r0}
                  ATL_vvrsum4(rC45, rC55, rC65, rC75);
